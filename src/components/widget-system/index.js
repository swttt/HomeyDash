  ...
  r.keys()
    .forEach(Key => {
      ...
      if (!widgetData.components.main) {
        widgetData.components.main = require('./widgets/' + widgetData.id + '/Main')
          .default
      } else {
        widgetData.components.main = require('./widgets/' + widgetData.id + '/' + widgetData.components.main)
          .default
      }

      if (widgetData.components.settings) {
        widgetData.components.settings = require('./widgets/' + widgetData.id + '/' + widgetData.components.settings)
          .default
      }
