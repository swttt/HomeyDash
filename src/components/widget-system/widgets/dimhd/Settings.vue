<template>
  <div class="col-12">
    <q-list no-border>
      ...
      <q-item tag="label">
        <q-item-main>
          <q-select filter filter-placeholder="Search device..." dark v-model="widget.settings.device" :options="dimdevices" stack-label="Select which dim capable device to show" />
        </q-item-main>
      </q-item>
      <q-item tag="label">
        <q-item-main>
